    ...
    if (result) {
      ...
      res.json({
        ...
        schedule: {
          ...
          label: `${moment.weekdays(schedule.dayOfWeek)} (${moment(schedule.startTime).tz(+req.query.timezone).format('LT')} - ${moment(schedule.endTime).format('LT')}) - ${schedule.numberInSchedule}`
        },
        teacher: {
