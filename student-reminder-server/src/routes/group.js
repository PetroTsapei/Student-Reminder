...
router.put('/api/groups/:id', [bodyValidator, tokenVerify, adminVerify, tokenValidate], GroupController.put);
router.delete('/api/groups/:id', [tokenVerify, adminVerify, tokenValidate], GroupController.delete);
